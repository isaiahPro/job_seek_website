    ...
    <div className={"flex flex-row justify-around"}>
      {blogList.map((item, index) => (
        <div
          key={index}
          className={
            "w-[350px] h-[540px] relative flex flex-col  gap-5 bg-slate-50 px-2 py-2 rounded-md "
          }
        >
          <div
            className={
              "w-[300px] absolute left-5 -top-3 mx-auto overflow-hidden h-[300px] shadow-blue-600 shadow-lg rounded-md"
            }
          >
            <img
              src={item.image}
          ...
          <div className={"font-roboto absolute bottom-3"}>
            <div className={"flex flex-row justify-between pr-10 my-3"}>
              ...
              <p className={"absolute font-extrabold font-serif text-base text-blue-900 right-[60px] bottom-[167px]"}>
